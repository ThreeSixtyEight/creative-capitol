  ...
  return (
    ...
    >
      ...
      <div style={{ height: '1000px' }}>
        <svg style={{top: yPositions[0], left: xPositions[0], position: 'absolute', }} xmlns="http://www.w3.org/2000/svg" width="420.001" height="603.111" viewBox="0 0 420.001 603.111">
          <g id="Group_76" data-name="Group 76" transform="translate(-750 -339.944)">
            <g id="Group_75" data-name="Group 75" transform="translate(9699 -7824)">
              ...
              <path id="Path_1631" data-name="Path 1631" d="M0,66.979v.042H66.979V0A66.979,66.979,0,0,0,0,66.979Z" transform="translate(-8671.979 8431.056) rotate(90)" opacity="0.6" />
              ...
              <path id="Path_1632" data-name="Path 1632" d="M0,63H126A63,63,0,1,0,0,63Z" transform="translate(-8940 8704)" fill="#fff" opacity="0.5" />
              ...
              <path id="Path_1635" data-name="Path 1635" d="M0,0V56.642H27.621c0-22.7,17.841-40.905,39.578-40.905s39.18,18.2,39.18,40.905H134V0Z" transform="translate(-8806 8633.056)" fill="#fff" opacity="0.387" />
            </g>
          </g>
        </svg>
